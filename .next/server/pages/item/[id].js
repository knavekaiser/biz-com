...
/* harmony import */ var _styles_products_module_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2370);
...
function Images({ product , variant  }) {
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        className: (_styles_products_module_scss__WEBPACK_IMPORTED_MODULE_3___default().images),
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                className: (_styles_products_module_scss__WEBPACK_IMPORTED_MODULE_3___default().thumbnails),
                children: (variant?.images || product.images).map((src, i)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_image__WEBPACK_IMPORTED_MODULE_2___default()), {
                        ...
                        width: 48,
                        alt: product.title,
                        className: viewImage === i ? (_styles_products_module_scss__WEBPACK_IMPORTED_MODULE_3___default().inView) : "",
                        onClick: ()=>{
                            setViewImage(i);
                        }
                    }, i))
            }),
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(MainImg, {
...
const MainImg = ({ src , alt  })=>{
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        className: (_styles_products_module_scss__WEBPACK_IMPORTED_MODULE_3___default().mainImg),
        ref: mainImgRef,
        onMouseMove: (e)=>{
            if (mainImgRef.current && imgRef.current) {
                const x = Math.round((e.clientX - (bounding?.x || 0)) / bounding?.width * 100);
                const y = Math.round((e.clientY - (bounding?.y || 0)) / bounding?.height * 100);
...
/* harmony import */ var _relatedProducts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7284);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_sidebar__WEBPACK_IMPORTED_MODULE_2__, _reviews__WEBPACK_IMPORTED_MODULE_4__, components_elements__WEBPACK_IMPORTED_MODULE_6__]);
([_sidebar__WEBPACK_IMPORTED_MODULE_2__, _reviews__WEBPACK_IMPORTED_MODULE_4__, components_elements__WEBPACK_IMPORTED_MODULE_6__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
// EXTERNAL MODULE: ./components/pages/item/styles/products.module.scss
var products_module = __webpack_require__(2370);
var products_module_default = /*#__PURE__*/__webpack_require__.n(products_module);
// EXTERNAL MODULE: ./components/pages/compare/products.js
var compare_products = __webpack_require__(230);
;// CONCATENATED MODULE: ./components/pages/item/relatedProducts.js
...
function Explore() {
    ...
    const [comparisons, setComparisons] = (0,external_react_.useState)([]);
    const router = (0,router_.useRouter)();
    const { get: getProducts  } = (0,hooks/* useFetch */.ib)(config/* endpoints.relatedItems */.Hv.relatedItems + `/${router.query.id}`);
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [
            products.length > 0 && /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                className: (products_module_default()).relatedProducts,
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                        className: (products_module_default()).head,
                        children: [
                            /*#__PURE__*/ jsx_runtime.jsx(Fire, {}),
                    ...
                    /*#__PURE__*/ jsx_runtime.jsx("div", {
                        ...
                        children: products.map((product, i)=>/*#__PURE__*/ jsx_runtime.jsx(productThumbnail/* ProductThumb */.B, {
                                product: product
                            }, product._id))
                    })
                ]
            }),
            comparisons.length > 0 && /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                className: (products_module_default()).comparison,
                children: [
                    /*#__PURE__*/ jsx_runtime.jsx("div", {
                        className: (products_module_default()).head,
                    ...
                    /*#__PURE__*/ jsx_runtime.jsx(compare_products/* CompareProducts */.v, {
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([react_hook_form__WEBPACK_IMPORTED_MODULE_7__, components_elements__WEBPACK_IMPORTED_MODULE_8__]);
([react_hook_form__WEBPACK_IMPORTED_MODULE_7__, components_elements__WEBPACK_IMPORTED_MODULE_8__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
